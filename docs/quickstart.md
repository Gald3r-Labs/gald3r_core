...
Choose the recommended installer for your processor from the [v5.1.0 release](https://github.com/Gald3r-Labs/gald3r_core/releases/tag/v5.1.0), and verify your download against its `SHA256SUMS.txt`.
...
If you selected Core, open a new terminal and run `gald3r --version` to verify 5.1.0.
